...
def label_to_tensor(frame, imgsize=(224, 224), gridsize=(11,11), classes=3, bboxes=2):
    ...
    return tensor
def augument_data(label, frame, imgsize=(224, 224), folder='flickr_logos_27_dataset_images/'):
    '''
...
def generator(label_keys, label_frames, batch_size=32, folder='flickr_logos_27_dataset_images/'):
    '''
    Generator function
    # Arguments
